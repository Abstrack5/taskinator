...
var createTaskEl = function (taskDataObj) {
  ...
  // add task id as a custom attribute syntax for set attribute: Element.setAttribute(name, value);
...
// target task to edit delete change progress
var createTaskActions = function (taskId) {
  ...
  // progress status select dropdown
